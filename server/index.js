...
app.post('/new', (req,res) => {
    ...
    var resp = req.body
    console.log(resp['id'])
    connection.query("INSERT into " + tbl + " VALUES (" + resp['id'] + ",\'" + resp['name'] + "\',\'" + resp['email'] + "\',\'" + resp['course'] + "\'," + resp['fees'] + ",\'" + resp['status'] + "\')", function (err, result) {
        if (err) throw err;
        console.log("Result: " + JSON.stringify(result));
        res.end(JSON.stringify(result))
    });
...
app.post('/update', (req,res) => {
    ...
    var resp = req.body
    console.log(resp['id'])
    connection.query("UPDATE " + tbl + " SET name= \'" + resp['name'] + "\', email=\'" + resp['email'] + "\',course=\'" + resp['course'] + "\',fees=" + resp['fees'] + ",status=\'" + resp['status'] + "\' where id = " + resp['id'], function (err, result) {
        if (err) throw err;
        console.log("Result: " + JSON.stringify(result));
        res.end(JSON.stringify(result))
    });
